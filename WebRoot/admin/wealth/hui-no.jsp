...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div id="scrollContent">
			...
			<div class="box2" panelTitle="无效审核" roller="true">
	
<s:form id="commitForm" action="hui-no!commit" method="post">
	<s:hidden name="id"/>

					<table class="tableStyle" formMode="true">
					
						<tr>
							<th colspan="2">无效审核</th>
						</tr>
						...
						<tr>
							<td>备注：</td>
							<td>
								<s:textarea id="content" name="content" 
									cssStyle="width:400px;height:60px"/>
							</td>
						</tr>
