...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link href="../skins/darkBlue/import_skin.css" rel="stylesheet" type="text/css" id="skin" themeColor="darkBlue" prePath="../"/>
		...
		<script type="text/javascript">
			...
			function getInfo(){
				...
				$.getJSON("alive.action",{rd:rnd},function(data){
				});
			}
		</script>
		<!--弹出式提示框end-->
									...
									<div id="rbox_middleright">
										<div id="bs_right">
											<iframe scrolling="no" width="100%" frameBorder=0 id=frmright
												name=frmright src="member/person-active-no.action" allowTransparency="true"></iframe>
										</div>
									</div>
								</div>
							</div>
