...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div id="scrollContent">
			...
			<div class="box2" panelTitle="修改商品" roller="true">
	
<s:form id="commitForm" action="product-update!update.action" method="post">
	<s:hidden id="id" name="id"/>
						...
						<table class="tableStyle" formMode="true">
							...
							<tr>
								<td width="10%">产品名称：</td>
								<td width="40%"><s:textfield id="title" name="title"/></td>
